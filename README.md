...
- [**Admin API Reference**](./reference/admin_api.md) — REST API v1 для панели управления: аутентификация, управление пользователями, комнатами, банами, настройками, бекапами, аудит-лог.
